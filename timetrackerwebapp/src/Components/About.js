 ...
 return(
  ...
  <h2 className="about-us-header">About Us</h2>
   <section className = 'our-start'>
    <div>
    <h3>Our Start</h3>
    <p>We are thrilled to embark on a new journey as TimeTracker, a dynamic and innovative venture founded on the principles of excellence and creativity.  With a dedicated team of experts and a passion for technology. As we embark on this exciting chapter, we are committed to fostering growth, cultivating meaningful relationships, and making a positive impact in our community. Join us on this exciting adventure as we shape the future of the employee management sector.</p>
    </div>
    <div>
    <h3>Our Mission</h3>
